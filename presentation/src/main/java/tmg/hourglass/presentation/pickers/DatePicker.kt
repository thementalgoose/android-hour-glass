    ...
    Dialog(onDismissRequest = { onDismissRequest() }, properties = DialogProperties()) {
        Column(
            ...
            Column(
                ...
                TextBody1(text = stringResource(id = R.string.select_date))
            ...
            Row(
                ...
                TextButton(
                    ...
                    TextBody1(text = stringResource(id = R.string.select_date_cancel))
                }
                ...
                TextButton(
                    ...
                    TextBody1(text = stringResource(id = R.string.select_date_confirm))
                }
            }
        }
    }
