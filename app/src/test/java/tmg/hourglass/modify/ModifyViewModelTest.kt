...
import tmg.hourglass.domain.data.CountdownInterpolator.ACCELERATE_DECELERATE
import tmg.hourglass.domain.data.CountdownInterpolator.LINEAR
import tmg.hourglass.domain.data.CountdownType
import tmg.hourglass.domain.data.CountdownType.DAYS
import tmg.hourglass.domain.data.CountdownType.GRAMS
